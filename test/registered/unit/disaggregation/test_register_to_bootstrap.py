...
class TestRegisterToBootstrap(CustomTestCase):
    ...
    def setUp(self):
        # register_to_bootstrap reads its config from the published bags
        # (get_parallel().load_balance_method / .enable_dsa_cache_layer_split,
        # get_serving().port) — seed them explicitly; the manager stays a mock.
