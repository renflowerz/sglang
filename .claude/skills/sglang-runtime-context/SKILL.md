...
7. **Migration-deferral ratchet** (`test_migration_deferral_ratchet.py`, pin 0): never
   module-skip a test "until the migration settles" — seed the context instead.
...
`test_migration_deferral_ratchet.py`, `test_runtime_context.py` — the last one doubles
