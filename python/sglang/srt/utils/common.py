...
def require_mlp_tp_gather(server_args: ServerArgs):
    ...
    # Parallel leaves come from the published bags: elastic-EP scale-up
    # rewrites dp_size there, and graph runners re-derive gather modes after
    # the scale (the instance a caller hands in stays at launch values).
